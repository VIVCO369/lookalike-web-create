...
const ThirtyDaysProfitsPage = () => {
  ...
  const challengeData = [
    { day: 1, balance: 100.00, perDay: "15%", session1: 0.30, session2: 0.30, session3: 0.30, session4: 0.30, session5: 0.30, tfProfit: 1.50, withdraw: "", stAmount: 1.50, extraStake: 0.20, reached: "Yes", superTrade: "", profit: "15%" },
    { day: 2, balance: 11.50, perDay: "15%", session1: 0.35, session2: 0.35, session3: 0.35, session4: 0.35, session5: 0.35, tfProfit: 1.73, withdraw: "", stAmount: 1.73, extraStake: 0.20, reached: "Yes", superTrade: "", profit: "15%" },
    { day: 3, balance: 13.23, perDay: "15%", session1: 0.40, session2: 0.40, session3: 0.40, session4: 0.40, session5: 0.40, tfProfit: 1.98, withdraw: "", stAmount: 1.98, extraStake: 0.20, reached: "Yes", superTrade: "", profit: "" },
    { day: 4, balance: 15.21, perDay: "15%", session1: 0.46, session2: 0.46, session3: 0.46, session4: 0.46, session5: 0.46, tfProfit: 2.28, withdraw: "", stAmount: 2.28, extraStake: 0.20, reached: "Yes", superTrade: "", profit: "" },
    ...
    { day: 6, balance: 18.11, perDay: "15%", session1: 0.54, session2: 0.54, session3: 0.54, session4: 0.54, session5: 0.54, tfProfit: 2.72, withdraw: "", stAmount: 2.72, extraStake: 0.25, reached: "Yes", superTrade: "", profit: "" },
    { day: 7, balance: 20.83, perDay: "15%", session1: 0.62, session2: 0.62, session3: 0.62, session4: 0.62, session5: 0.62, tfProfit: 3.12, withdraw: "", stAmount: 3.12, extraStake: 0.25, reached: "Yes", superTrade: "", profit: "" },
    { day: 8, balance: 23.96, perDay: "15%", session1: 0.72, session2: 0.72, session3: 0.72, session4: 0.72, session5: 0.72, tfProfit: 3.59, withdraw: "", stAmount: 3.59, extraStake: 0.25, reached: "Yes", superTrade: "", profit: "" },
    { day: 9, balance: 27.55, perDay: "15%", session1: 0.83, session2: 0.83, session3: 0.83, session4: 0.83, session5: 0.83, tfProfit: 4.13, withdraw: "", stAmount: 4.13, extraStake: 0.25, reached: "Yes", superTrade: "", profit: "" },
    { day: 10, balance: 31.68, perDay: "15%", session1: 0.95, session2: 0.95, session3: 0.95, session4: 0.95, session5: 0.95, tfProfit: 4.75, withdraw: "", stAmount: 4.75, extraStake: 0.40, reached: "Yes", superTrade: "", profit: "" },
    { day: 11, balance: 36.43, perDay: "15%", session1: 1.09, session2: 1.09, session3: 1.09, session4: 1.09, session5: 1.09, tfProfit: 5.46, withdraw: "", stAmount: 5.46, extraStake: 0.40, reached: "No", superTrade: "", profit: "" },
    ...
    { day: 13, balance: 48.18, perDay: "15%", session1: 1.45, session2: 1.45, session3: 1.45, session4: 1.45, session5: 1.45, tfProfit: 7.23, withdraw: "", stAmount: 7.23, extraStake: 0.40, reached: "No", superTrade: "", profit: "" },
    { day: 14, balance: 55.41, perDay: "15%", session1: 1.66, session2: 1.66, session3: 1.66, session4: 1.66, session5: 1.66, tfProfit: 8.31, withdraw: "", stAmount: 8.31, extraStake: "", reached: "Yes", superTrade: "", profit: "" },
    { day: 15, balance: 63.72, perDay: "15%", session1: 1.91, session2: 1.91, session3: 1.91, session4: 1.91, session5: 1.91, tfProfit: 9.56, withdraw: "", stAmount: 9.56, extraStake: 0.40, reached: "", superTrade: "", profit: "" },
    { day: 16, balance: 73.28, perDay: "15%", session1: 2.20, session2: 2.20, session3: 2.20, session4: 2.20, session5: 2.20, tfProfit: 10.99, withdraw: "", stAmount: 10.99, extraStake: 0.40, reached: "", superTrade: "", profit: "" },
    ...
    { day: 18, balance: 76.91, perDay: "15%", session1: 2.31, session2: 2.31, session3: 2.31, session4: 2.31, session5: 2.31, tfProfit: 11.54, withdraw: "", stAmount: 11.54, extraStake: 1.00, reached: "", superTrade: "", profit: "" },
    { day: 19, balance: 88.45, perDay: "15%", session1: 2.65, session2: 2.65, session3: 2.65, session4: 2.65, session5: 2.65, tfProfit: 13.27, withdraw: "", stAmount: 13.27, extraStake: 1.00, reached: "", superTrade: "", profit: "" },
    { day: 20, balance: 101.72, perDay: "15%", session1: 3.05, session2: 3.05, session3: 3.05, session4: 3.05, session5: 3.05, tfProfit: 15.26, withdraw: "", stAmount: 15.26, extraStake: 1.00, reached: "", superTrade: "", profit: "" },
    { day: 21, balance: 116.97, perDay: "15%", session1: 3.51, session2: 3.51, session3: 3.51, session4: 3.51, session5: 3.51, tfProfit: 17.55, withdraw: "", stAmount: 17.55, extraStake: 1.00, reached: "", superTrade: "", profit: "" },
    ...
    { day: 23, balance: 129.70, perDay: "15%", session1: 3.89, session2: 3.89, session3: 3.89, session4: 3.89, session5: 3.89, tfProfit: 19.45, withdraw: "", stAmount: 19.45, extraStake: 2.00, reached: "", superTrade: "", profit: "" },
    { day: 24, balance: 149.15, perDay: "15%", session1: 4.47, session2: 4.47, session3: 4.47, session4: 4.47, session5: 4.47, tfProfit: 22.37, withdraw: "", stAmount: 22.37, extraStake: 2.00, reached: "", superTrade: "", profit: "" },
    { day: 25, balance: 171.53, perDay: "15%", session1: 5.15, session2: 5.15, session3: 5.15, session4: 5.15, session5: 5.15, tfProfit: 25.73, withdraw: "", stAmount: 25.73, extraStake: 2.00, reached: "", superTrade: "", profit: "" },
    { day: 26, balance: 197.25, perDay: "15%", session1: 5.92, session2: 5.92, session3: 5.92, session4: 5.92, session5: 5.92, tfProfit: 29.59, withdraw: "", stAmount: 29.59, extraStake: 2.00, reached: "", superTrade: "", profit: "" },
    ...
    { day: 28, balance: 230.87, perDay: "15%", session1: 6.93, session2: 6.93, session3: 6.93, session4: 6.93, session5: 6.93, tfProfit: 34.63, withdraw: "", stAmount: 34.63, extraStake: 3.00, reached: "", superTrade: "", profit: "" },
    { day: 29, balance: 265.50, perDay: "15%", session1: 7.96, session2: 7.96, session3: 7.96, session4: 7.96, session5: 7.96, tfProfit: 39.82, withdraw: "", stAmount: 39.82, extraStake: 3.00, reached: "", superTrade: "", profit: "" },
